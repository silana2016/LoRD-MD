                    ...
                    sections: [{
								...
								"rows": [
									...
									},
									{
										...
										{
											"title": "أوامر خاصة بصاحب البوت",
										"description": "",
										"rowId": `databasemenu`
										},
										{
											"title": "اوامر غير مهمة ",
										"description": "",
										"rowId": `anonymousmenu`
										},
										{
...
case 'allmenu': {
  	anu = `
   مرحبا اسمي Noureddine ouafy
   هذا البوت هدية لكل شخص يتابعني ♥
   انستغرامي : 
  noureddine_ouafy
  جمــــيع الاوامــــر

  ☺*اوامر تحميل الفيديوات*☺   
...
𑁍 ${prefix}𝑔𝑖𝑚𝑎𝑔𝑒 [بحث عن الصور]
𑁍 ${prefix}𝑤𝑎𝑙𝑙𝑝𝑎𝑝𝑒𝑟 [البحث عن الصور]
𑁍 ${prefix}𝑤𝑖𝑘𝑖𝑚𝑒𝑑𝑖𝑎 [البحث في ويكي]
𑁍 ${prefix}𝑦𝑡𝑠𝑒𝑎𝑟??ℎ [البحث في يوتوب]
𑁍 ${prefix}𝑟𝑖𝑛𝑔𝑡𝑜𝑛𝑒 [بحث عن رنة ]

   
   🎨*أوامر تحويل الملفات*🎨
   
🌼 ${prefix}𝑡𝑜𝑖𝑚𝑎𝑔𝑒  [تحويل ملصق لصورة]
🌼 ${prefix}𝑟𝑒𝑚𝑜𝑣𝑒𝑏𝑔  [مسح خلفية اي صورة]
🌼 ${prefix}𝑠𝑡𝑖𝑐𝑘𝑒𝑟 [تحويل صورة لملصق]
🌼 ${prefix}𝑒𝑚𝑜𝑗𝑖𝑚𝑖𝑥 [دمج ملصقات]
🌼 ${prefix}𝑡𝑜𝑣𝑛 [تحويل نص لاوديو]
...
break
	   ...
	   anu = `
🔥اسطورة البوتات بــوبيز بـــوت
 
✘ النسخة : 4

✘ صاحب البوت: Noureddine ouafy

✘ ما الجديد ?: يدعم اللغة العربية 😍
...
`
                ...
                let btn = [{
                                urlButton: {
                                    displayText: ' ♥قناتي',
                                    url: 'youtube.com/noureddineouafy'
                                }
                            }, {
                                urlButton: {
